...
<input type="hidden" id="bgmServer" name="bgmServer" value="http://localhost:8080/mvc"/>
<!-- <input type="hidden" id="apiServer" name="apiServer" value="http://140.143.25.65/v"/>
<input type="hidden" id="bgmServer" name="bgmServer" value="http://47.103.194.37/mvc"/> -->
